                        ...
                        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <div class="mt-2" id="comment-sections">
                                        <!-- Pakai AJAX -->
        ...
        <div class="max-w-xl mx-auto py-24">
            ...
            @foreach ($articles as $item)
                <article class="prose lg:prose-xl py-3">
                    ...
                    {{-- command code : ctrl + / --}}
                    {{-- {{ $item->article }} --}}
                    <p><strong>Article - {{ $item->id }}</strong></p>
                    <p>{!! $item->article !!}</p>
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        for (var i = 0; i < result.data.length; i++) {
                            ...
                            commentsHtml += '<p class="text-bold">'
                            commentsHtml += comment.name
                            commentsHtml += '</p>'

                            commentsHtml += '<p class="text-sm text-gray-500">'
                        ...
                        $('#comment-sections').html(commentsHtml);
                    }
                })
                $("#comments-modal").show();
            });
